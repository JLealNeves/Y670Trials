...
public class DefaultBandDAO implements BandDAO {
    ...
    public List<BandModel> findBands() {
        final String query = "SELECT {" + BandModel.PK + "} "
    ...
    public void setFlexibleSearchService(FlexibleSearchService flexibleSearchService) { this.flexibleSearchService = flexibleSearchService; }
}
